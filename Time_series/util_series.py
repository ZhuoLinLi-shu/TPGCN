...
class DataLoaderS_stamp(object):
    ...
    def _split(self, train, valid, test):
        ...
        print('train data shape is {}----------train label shape is {}'.format(self.train[0].shape, self.train[1].shape))
        print('valid data shape is {}----------valid label shape is {}'.format(self.valid[0].shape, self.valid[1].shape))
